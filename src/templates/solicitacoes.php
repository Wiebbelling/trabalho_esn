      ...
      <div class="row">
        ...
        <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
          ...
          <?php if (isset($_GET['erro']) && $_GET['erro'] == 1): ?>
            <div class="alert alert-danger">Quantidade da solicitação é maior que quantidade disponível em estoque.</div>
          <?php endif; ?>
          ...
          <div class="well" style="margin: 20px; padding: 20px; background: #ccc; display: none" id="pesquisar">
            <form class="form form-vertical" action="" method="post">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="solicitante" style="width: 500px">
                <option value="">Selecione um solicitante ou deixe em branco</option>
                <?php foreach ($solicitantes as $solicitante): ?>
                  <option value="<?php echo $solicitante['id'] ?>"><?php echo $solicitante['usuario'] ?></option>
                <?php endforeach; ?>
                </select>
              </div>
            ...
            <table class="table table-striped">
              ...
              foreach ($movimentacoes as $movimentacao) {
                  ...
                  if ($status == 'Aguardando') {
                      echo '<td><a class="btn btn-primary btn-sm" href="aprovar.php?id='.$movimentacao['id'].'">APROVAR</a> <a class="btn btn-danger btn-sm" href="rejeitar.php?id='.$movimentacao['id'].'">REJEITAR</a></td>';
                  } else {
                      echo '<td>'.$status.'</td>';
                  }
                  echo "</tr>";
